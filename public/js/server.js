...
var _app$$meta$addApp = app.$meta().addApp('custom'),
    set = _app$$meta$addApp.set;
...
vue_server_renderer_basic__WEBPACK_IMPORTED_MODULE_1___default()(_app__WEBPACK_IMPORTED_MODULE_0__["default"], function (err, html) {
  ...
  var meta = _app__WEBPACK_IMPORTED_MODULE_0__["default"].$meta().inject();
  dispatch({
    html: html,
    vueMeta: {
...
/***/ 0:
/*!****************************************************************!*\
  !*** multi ./resources/js/server.js ./resources/sass/app.scss ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /var/www/resources/js/server.js */"./resources/js/server.js");
